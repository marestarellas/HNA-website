			...
			<div className="mt-4 flex flex-col gap-6 sm:flex-row sm:items-start">
				...
				<div className="flex-1">
					...
					<p className="mt-4 font-serif text-[15px] leading-relaxed text-foreground/85">
						...
						the comparison step actually is: a difference between two numbers. The
						complexity lives entirely in the <em>feature</em> — never in the coupling
						operation — which is worth knowing before the family name convinces you
						otherwise.
					</p>
				</div>
			</div>
