...
export default function ExperimentPage() {
	return (
		<StubPage
			eyebrow="Section 4"
			title="Experiment"
			intro="A short sequence of generated nature stimuli, with a brief phenomenological self-report after each. A research-grade data-collection instrument disguised as an experience — the most controlled UX on the site."
			willInclude={[
